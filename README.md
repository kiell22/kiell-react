...
```bash
git clone https://github.com/kiell22
cd portofolio
````
...
Hai, saya jeskiel siahaan (username GitHub: `kiell22`).
...
* **Email:** [email\_jeskielsiahaan@gamil.com](mailto:email_jeskielsiahaan@gmail.com)
* **LinkedIn:** [linkedin.com/in/jeskiel](https://www.linkedin.com/in/jeskiel/)
* **Instagram (opsional):** @jeskielsiahaan
---
